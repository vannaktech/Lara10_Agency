...
<body>
    ...
    <!-- Destination Start -->
        {{-- @include('partial.destination')
    <!-- Destination Start --> --}}


    <!-- Package Start -->
        @include('partial.packages')
    <!-- Package End -->


    <!-- Booking Start -->
        @include('partial.booking')
    <!-- Booking Start -->
